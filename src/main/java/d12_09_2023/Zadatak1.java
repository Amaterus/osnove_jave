...
public class Zadatak1 {
    public static void main(String[] args){
        ...
        */
        ...
        FizickoLice prodavac = new FizickoLice("Veljko Andjelkovic", "123456789", "1234567890123", true);
        FizickoLice kupac = new FizickoLice("Pera Peric", "987654321", "9876543210123", false);

        Ugovor ugovor = new Ugovor(2023, 12, 9, prodavac, kupac, 150000, "Ozrenska 123, Beograd");
        ugovor.stampaj();
    }
}
