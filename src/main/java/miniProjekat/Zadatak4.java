...
//        Komanda iz primera je komanda koja pokreće Locust skriptu za stres testiranje. Ukoliko ste zainteresovani, preporučuje se da istražite alat Locust.
...
//        Komanda: locust -f login_stress_test.py -u 1000 -r 5  -t 100 --headless –host  https://cms.demo.katalon.com/ --html login_stress_report.html
        ...
        while(locustCommand.contains("$")){
            System.out.println("Komanda: "+ locustCommand);
            ...
            locustCommand = locustCommand.replace(toReplace,replacement);
        }
        System.out.println("Komanda: "+ locustCommand);
    }
}
